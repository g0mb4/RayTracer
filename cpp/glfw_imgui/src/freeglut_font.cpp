...
/* The font structure: */
const SFG_Font fgFontHelvetica12 = {256, 16, Helvetica12_Character_Map, 0, 4 };

// fg_font.c
// line: 99
void glutBitmapCharacter(int character) {
	const SFG_Font * font = &fgFontHelvetica12;
	const unsigned char * face = font->Characters[character];
...
void glutBitmapString(const unsigned char * string) {
	...
	while ((c = *string++))
		...
		{
			const unsigned char * face = font->Characters[c];
