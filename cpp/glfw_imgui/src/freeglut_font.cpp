...
// fg_font.c
// line: 133
void glutBitmapCharacterMod(const unsigned char * string) {
	unsigned char c;
	float x = 0.0f;
	const SFG_FontMod * font = &fgFontFixed9x15;
