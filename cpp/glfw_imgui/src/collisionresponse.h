...
{
public:
	CollisionResponse(Intersection & intersection, Ray * ray, double refl_index_medium, ShapeSet * scene, Ray * reflected, Ray * refracted);
	virtual ~CollisionResponse() {};

private:
	void planeCollision(Plane * p, Point c, Ray * ray, double refl_index_medium, ShapeSet * scene, Ray * reflected, Ray * refracted);
	void ellipsoidCollision(Ellipsoid * s, Point c, Ray * ray, double refl_index_medium, Ray * reflected, Ray * refracted);
